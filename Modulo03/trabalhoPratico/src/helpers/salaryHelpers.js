...
function calculatePercentageProgressBar(
  fullSalary,
  discountINSS,
  discountIRPF,
  netSalary
) {
  let percentDiscountINSS = 0,
    percentDiscountIRPF = 0,
    percentNetSalary = 0;

  percentDiscountINSS = (discountINSS * 100) / fullSalary;
  percentDiscountIRPF = (discountIRPF * 100) / fullSalary;
  percentNetSalary = (netSalary * 100) / fullSalary;
  return { percentDiscountINSS, percentDiscountIRPF, percentNetSalary };
}

export { calculateSalaryFrom, calculatePercentageProgressBar };
